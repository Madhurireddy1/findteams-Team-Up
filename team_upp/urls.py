...
urlpatterns = [
    ...
    path('<int:team_upp_id>/', views.detail, name='details'),
    path('category/<str:category>/', views.tup_category, name='category'),
    path('join_tup/<int:recruiter>/', views.join_tup, name='join_tup'),
    path('show_teamup_details', views.show_teamup_details,
         name='show_teamup_details'),
    ...
    path('remove_teammate/<int:adv>/',
         views.remove_teammate, name='remove_teammate'),
]
